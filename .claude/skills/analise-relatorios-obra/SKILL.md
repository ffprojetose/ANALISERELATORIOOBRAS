...
3. Ler primeiro `obras/<obra-ativa>/CLAUDE.md` e os documentos em `obras/<obra-ativa>/docs/` antes de iniciar qualquer análise.
...
23. Nunca alterar automaticamente `docs/requirements.md`, `docs/metodologia/*.md` ou o `CLAUDE.md` da raiz — qualquer mudança na metodologia geral deve ser proposta separadamente e depender de aprovação expressa.
