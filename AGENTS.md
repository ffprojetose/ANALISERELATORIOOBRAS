...
## Obras Ativas
- `obras/reserva-park/` → ver `obras/reserva-park/AGENTS.md`
...
## Fluxo de Trabalho
1. Identifique a obra ativa e leia `docs/state.md` (plataforma) e o `AGENTS.md` da obra antes de qualquer ação.
